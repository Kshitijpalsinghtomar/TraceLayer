/**
 * SignInPage — Branded redirect launcher for Logto sign-in.
 *
 * Auto-redirects to Logto's hosted login page on mount.
...
export function SignInPage() {
    ...
    // Auto-redirect to Logto on mount (if not already authenticated)
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center px-6">
            <div className="max-w-sm w-full text-center">
                ...
                <h2 className="text-lg font-medium text-foreground mb-1">Redirecting to sign in...</h2>
